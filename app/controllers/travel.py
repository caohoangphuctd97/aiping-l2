...
from app.utils.make_request import (
    make_request_with_retries, render_payload_for_travel_recommendation
)
...
async def get_travel_recommendations(
    ...
    payload = await render_payload_for_travel_recommendation(
        data=data, **kwargs
    )
   ...
   # Extract the list part from the content
    ...
    return TravelRecommendationRes(
        ...
        season=data.season,
        recommendations=travel_destinations
    )